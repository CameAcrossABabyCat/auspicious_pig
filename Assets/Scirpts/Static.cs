...
public class Static
{
    ...
    //替换芯域名
    public string URL = "http://jxzhz.4cv47.cn/";//"http://zshz.hlrb7.cn/";//"http://lpgw.hlrb7.cn/";//"http://alihz.hlrb7.cn/";//"http://www.hcfir.cn/";//http://straw.mmykw.cn//http://test.mmykw.cn/
